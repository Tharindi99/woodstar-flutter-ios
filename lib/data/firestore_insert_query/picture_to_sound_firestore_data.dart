...
/// Unshuffled source rounds for Picture -> Sound.
/// Write target: `pictureToSound/round01` ... `roundNN`.
final List<Map<String, dynamic>> pictureToSoundFirestoreRoundsUnshuffled = [
  {
    'roundNumber': 1,
  ...
  },
  {
    ...
    'options': [
      ...
      {
        'soundId': 'bensaw fair wood',
        'soundPath': 'audios/bensaw-fair-wood_cropped.mp3',
        'title': 'bensaw fair wood',
      },
      {
        'soundId': 'Circular Saw Machine OKA Tree',
        'soundPath': 'audios/Circular Saw Machine OKA Tree.mp3',
  ...
  },
  {
    ...
    'options': [
      {
        'soundId': 'Lamello cutter',
        'soundPath': 'audios/Lamello cutter.m4a',
        'title': 'Lamello cutter',
      },
      {
        'soundId': 'Edge grinder',
        'soundPath': 'audios/Edge grinder.m4a',
  ...
  },
  {
    ...
    'correctAnswer': 'Hand drilling chipboard',
    'score': 70,
    'options': [
      {
        'soundId': 'Hand drilling fur wood',
        'soundPath': 'audios/Hand drilling-für-wood.mp3',
        'title': 'Hand drilling fur wood',
      },
      {
        'soundId': 'cordless screwdrawer',
        'soundPath': 'audios/cordless screwdrawer.m4a',
        'title': 'cordless screwdrawer',
      },
      {
        'soundId': 'Hand drilling chipboard',
        'soundPath': 'audios/Hand drilling-chipboard.mp3',
        'title': 'Hand drilling chipboard',
      },
      {
        'soundId': 'drilling machine fur wood',
        'soundPath': 'audios/drilling machine-für-wood.mp3',
        'title': 'drilling machine fur wood',
      },
    ],
  },
  {
    ...
    'correctAnswer': 'Hand drilling fur wood',
    'score': 70,
    'options': [
      {
        'soundId': 'Hand drilling chipboard',
      ...
      {
        'soundId': 'drilling machine oak wood',
        'soundPath': 'audios/drilling machine-oak-wood.mp3',
        'title': 'drilling machine oak wood',
      },
      {
        'soundId': 'Hand drilling fur wood',
        'soundPath': 'audios/Hand drilling-für-wood.mp3',
  ...
  },
  {
    ...
    'correctAnswer': 'Lamello cutter',
    'score': 70,
    'options': [
      {
        'soundId': 'Table miling machine',
        'soundPath': 'audios/Table miling machine.m4a',
        'title': 'Table miling machine',
      },
      {
        'soundId': 'milling machine',
  ...
  },
  {
    ...
    'options': [
      {
        'soundId': 'Nailing wood stick piece',
  ...
  },
  {
    ...
    'options': [
      ...
      {
        'soundId': 'Table miling machine change blade',
        'soundPath': 'audios/Table miling machine change blade.m4a',
        'title': 'Table miling machine change blade',
      },
      {
        'soundId': 'Table miling machine',
        'soundPath': 'audios/Table miling machine.m4a',
  ...
  },
  {
    ...
    'correctAnswer': 'bensaw fair wood',
    'score': 70,
    'options': [
      {
        'soundId': 'Hand circular saw',
  ...
  },
  {
    ...
    'correctAnswer': 'drilling machine fur wood',
    'score': 70,
    'options': [
      {
        'soundId': 'drilling machine oak wood',
  ...
  },
  {
    ...
    'correctAnswer': 'drilling machine oak wood',
    'score': 70,
    'options': [
      {
        'soundId': 'drilling machine oak wood',
      ...
      {
        'soundId': 'drilling with different tool',
        'soundPath': 'audios/drilling-with-different-tool_(Random).mp3',
        'title': 'drilling with different tool',
      },
      {
        'soundId': 'drilling machine fur wood',
        'soundPath': 'audios/drilling machine-für-wood.mp3',
  ...
  },
  {
    'roundNumber': 22,
    'imagePath': 'images/Drill Machine fur Wood.jpeg',
    'correctAnswer': 'drilling machine fur wood random',
    'score': 70,
    'options': [
      {
        'soundId': 'cordless screwdrawer',
      ...
      {
        'soundId': 'drilling machine fur wood random',
        'soundPath': 'audios/drilling-machine für-wood (Random).mp3',
        'title': 'drilling machine fur wood random',
      },
      {
        'soundId': 'Hand drilling fur wood',
        'soundPath': 'audios/Hand drilling-für-wood.mp3',
  ...
  },
  {
    'roundNumber': 23,
    'imagePath': 'images/Drill Machine fur Wood.jpeg',
    'correctAnswer': 'drilling with different tool',
    'score': 70,
    'options': [
      {
        'soundId': 'drilling machine fur wood',
  ...
  },
  {
    ...
    'correctAnswer': 'planning machine beachwood',
    'score': 70,
    'options': [
      {
        'soundId': 'planning machine',
      ...
      {
        'soundId': 'planning machine beachwood',
        'soundPath': 'audios/planning-machine-1-beachwood_cropped.mp3',
        'title': 'planning machine beachwood',
      },
      {
        'soundId': 'Table miling machine',
        'soundPath': 'audios/Table miling machine.m4a',
  ...
  },
  {
    ...
    'correctAnswer': 'planning machine',
    'score': 70,
    'options': [
      {
        'soundId': 'milling machine',
...
Map<String, dynamic> pictureToSoundRoundWithShuffledOptions(
  ...
  options.shuffle(Random(seed * 31_337 + 29));
  return Map<String, dynamic>.from(round)..['options'] = options;
}

/// Shuffled copy for app/runtime usage and Firestore writes.
final List<Map<String, dynamic>> pictureToSoundFirestoreRounds =
    pictureToSoundFirestoreRoundsUnshuffled
        .map(pictureToSoundRoundWithShuffledOptions)
        .toList();
